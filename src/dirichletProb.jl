###
# Computing Dirichlet probabilities
#
# Computes Prob(v^T p <= t) for p a dirichlet r.v.
# Computation proceeds by inverting the characteristic function
####

#the relevant integrands for characteristic fcn
#vbars = vs - te
